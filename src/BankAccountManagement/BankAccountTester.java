...
public class BankAccountTester {
	...
	public static void main(String[] args) {
		try (Scanner sc = new Scanner(System.in)) {
			...
			Map<Integer, BankAccount> accountMap = BankingUtils.populateAccountMap();
			boolean exit = false;
			while (!exit) {
				...
				try {
					...
					case 1:
						...
						BankAccount acct = BankingValidations.validateAllInputs(sc.nextInt(), sc.next(), sc.next(), sc.nextDouble(),
								sc.next(), accountMap);
					...
					case 5:
						...
						System.out.println("Closed the account for customer : " + acct.getCname());

						break;
					case 6: // disable accts
						BankingValidations.disableAccounts(accountMap);
						break;
