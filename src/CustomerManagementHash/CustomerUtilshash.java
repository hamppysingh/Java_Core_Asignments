...
public class CustomerUtilshash {
	...
	public static boolean authenticationadmin(String email,String password,Map<String,Customer> L) throws InvalidInputException{
		Customer Cust=new Customer(Validaterules.Checkmailsyntax(email),password);
		if(!(L.get(email).getEmail().equals(Cust.getEmail())&&(L.get(email).getPassword().equals(Cust.getPassword()))))
			throw new InvalidInputException(" Authenication failed...You are not the admin !! ");
		return true;
	}
	public static Map<String,Customer> addcustomdata(Map<String,Customer> map)
	{
		...
		map.put("praveen@gmail.com",new Customer("Jinn","Von","praveen@gmail.com","Teddy245!",Validaterules.validateparse("2001-07-19"),10000.00,Validaterules.validateparse("2021-09-17"),ServicePlan.PLATINUM));
		...
		map.put("smito242@gmail.com",new Customer("David","Jones","davidjon2542@gmail.com","DJones456!",Validaterules.validateparse("2003-10-31"),5000.00,Validaterules.validateparse("2023-02-24"),ServicePlan.DIAMOND));
		map.put("smito242@gmail.com",new Customer("Lisa","Williams","lizard@gmail.com","LWilliams789!",Validaterules.validateparse("2003-03-24"),1000.00,Validaterules.validateparse("2023-10-12"),ServicePlan.SILVER));
		return map;
	}
}
