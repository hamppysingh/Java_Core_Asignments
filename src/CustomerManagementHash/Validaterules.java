...
import CustomerManagement.DuplicateValueException;
import CustomerManagement.InvalidInputException;
import CustomerManagement.ServicePlan;
import CustomerManagement.ValidNotCorrect;
public class Validaterules {
		...
		public static String validatemail(String email,Map<String,Customer> L) throws DuplicateValueException{
			Customer M=new Customer(email);
			if(L.containsValue(M))
		...
		public static Customer validateallinputs(String fname, String lname, String email, String password,String dob, double regamount,String lastpaidsuscription,String sp,Map<String,Customer> C) throws DateTimeParseException,InvalidInputException,DuplicateValueException{
